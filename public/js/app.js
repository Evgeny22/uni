...
$(document).on('click', '.panel-heading', function(e) {
    var $this = $(this);
    var $toggleLink = $this.find('a[data-toggle="collapse"]');
    var $indicator = $this.find('.panel-indicator');

    if ($toggleLink.hasClass('collapsed')) {
        $indicator.addClass('ti-angle-down').removeClass('ti-angle-up');
    } else {
        $indicator.addClass('ti-angle-up').removeClass('ti-angle-down');
    }
});
...
(function($, clearui) {
    ...
    clearui.clearAnimatePanel = function() {
        console.log('clearui.clearAnimatePanel function called...');
        if ($('#right').length) {
            $rightToggle.on("click", function(e) {
                console.log('Right toggle event fired...');
                switch (true) {
                    // Close right panel
            ...
            console.log('Added hidden class to right panel...');
